  ...
  return (
    <div className="p-4 main-contents" style={{ flex: 1, }}>
      ...
      <div
        ...
        <span style={{ textDecoration: "underline",fontSize:'1.12rem' }}>ChildHealth</span>
      </div>

      {/* Header */}
      <div className="d-flex justify-content-between align-items-center mb-4">
        <div className=" d-none  align-items-center gap-3 text">
          <MdChildCare size={32} color="#00A99D" />

          <div>
            <h2 className="mb-1">Child Health</h2>
            <p className="text-muted mb-0 d-flex" style={{fontSize:'1.12rem'}}>
                ...
                {isMobileView ? (
                  <>
                    ...
                    <div className="ms-1">
                      ...
                      >
                        <MdChildCare size={16} className="me-1" />
                  ...
                  <>
                    ...
                    <div className="d-flex align-items-center mb-3">
                      ...
                      <div className="ms-3">
                       ...
                       <div
  style={{ color: "#00A99D", fontSize: "14px" }}
  className="d-flex speciality align-items-center"
>
  <MdChildCare size={16} className="me-1" />
  {doc.speciality} <span className="ms-1"> | {doc.experience}</span>
</div>
